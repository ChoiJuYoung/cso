...
'****************************************************************
' 만든이 : Alexander Mungall[goober_mpc@hotmail.com]
' 컨트롤 명 : xFrame[xFrame.ctl] (1.0ver)
' 수정 : Energizer[vhgkd203@naver.com]
' + 프레임 그리기시 오류
' + 결림
'----------------------------------------------------------------
' xFrame Copyright� Alexander Mungall, All Rights Reserved
' 1.0 ver
' http://planet-source-code.com/vb/scripts/ShowCode.asp?txtCodeId=68342&lngWId=1
' 2.0 ver [월페이퍼, 가로접기 기능 추가] 오류 many many
' http://planet-source-code.com/vb/scripts/ShowCode.asp?txtCodeId=73196&lngWId=1
'****************************************************************
    Option Explicit
